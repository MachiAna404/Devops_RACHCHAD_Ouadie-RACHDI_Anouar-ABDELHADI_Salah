...
#### ✅ **Objectif**  
Nous avons utilisé l’image `python:3.8-buster` comme base pour notre conteneur. Nous avons ajouté les informations du mainteneur dans le Dockerfile avec `LABEL maintainer`.
